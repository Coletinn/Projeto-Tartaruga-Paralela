...
Para a terceira versão, utilizando OpenMP o resultado obtido para um valor de 1000000 (um milhão) foi de 18.997896, sendo bem mais otimizado e mais rápido do que a versão anterior, ou seja, houve um aumento notável de performance.<br/>

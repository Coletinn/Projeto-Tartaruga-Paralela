...
Para a terceira versão, utilizando OpenMP o resultado obtido para um valor de 1000000 (um milhão) foi de 14.392727, sendo bem mais otimizado e mais rápido do que a versão anterior, ou seja, houve um aumento notável de performance.<br/>
![image](https://user-images.githubusercontent.com/62111019/169896406-251d5303-2655-47a7-98ae-0827491e939a.png)


### Speedup
O speedup calculado após a implementação da segunda versão (pthreads) foi de 3,0769230769 com 4 threads.<br/>
Para a versão utilizando OpenMP, o speedup calculado com 20 threads foi de 1, ou valores com pequenas variações.
